...
Here is the entire program (from [pgvector-vectorstore-example](https://github.com/ankit-arora/langchaingo/blob/main/examples/pgvector-vectorstore-example/pgvector_vectorstore_example.go)):
