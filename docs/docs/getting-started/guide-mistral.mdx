...
```shell
go run github.com/whichxjy/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-chat-example](https://github.com/whichxjy/langchaingo/blob/main/examples/mistral-chat-example/mistral_chat_example.go)).
...
import (
	...
	"github.com/whichxjy/langchaingo/llms/mistral"
)
